...
# classes
District_Heat                      = create_class(GFB, 'District_Heat'                     , BRICK['Equipment']                   , 'District heating infrastructure')
Radiator                           = create_class(GFB, 'Radiator'                          , BRICK['Equipment']                   , 'Radiator')
...
Water_Pressure_Sensor              = create_class(GFB, 'Water_Pressure_Sensor'             , BRICK['Pressure_Sensor']             , 'Water pressure sensor')
Water_Differential_Pressure_Sensor = create_class(GFB, 'Water_Differential_Pressure_Sensor', BRICK['Differential_Pressure_Sensor'], 'Water differential pressure virtual sensor')
...
feedsSupplyDistrictHeatedWater = create_property(GFB, 'feedsSupplyDistrictHeatedWater', 'object', [District_Heat], [], parent=feedsDistrictHeatedWater)
feedsReturnDistrictHeatedWater = create_property(GFB, 'feedsReturnDistrictHeatedWater', 'object', [], [District_Heat], parent=feedsDistrictHeatedWater)
